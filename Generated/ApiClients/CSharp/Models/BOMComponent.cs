...
#nullable restore
        ...
        public global::VaultDataApi.Models.BOMStructureEnum? BOMStructure { get; set; }
        ...
        public global::VaultDataApi.Models.ComponentTypeEnum? ComponentType { get; set; }
...
#nullable restore
        ...
        public global::VaultDataApi.Models.XRefTypeEnum? XRefType { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::VaultDataApi.Models.BOMComponent"/> and sets the default values.
        /// </summary>
        public BOMComponent()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::VaultDataApi.Models.BOMComponent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::VaultDataApi.Models.BOMComponent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::VaultDataApi.Models.BOMComponent();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "bOMStructure", n => { BOMStructure = n.GetEnumValue<global::VaultDataApi.Models.BOMStructureEnum>(); } },
                { "baseQty", n => { BaseQty = n.GetStringValue(); } },
                { "baseUOM", n => { BaseUOM = n.GetStringValue(); } },
                { "componentType", n => { ComponentType = n.GetEnumValue<global::VaultDataApi.Models.ComponentTypeEnum>(); } },
                { "id", n => { Id = n.GetStringValue(); } },
                { "isCloaked", n => { IsCloaked = n.GetBoolValue(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "uniqueId", n => { UniqueId = n.GetStringValue(); } },
                { "xRefId", n => { XRefId = n.GetStringValue(); } },
                { "xRefType", n => { XRefType = n.GetEnumValue<global::VaultDataApi.Models.XRefTypeEnum>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::VaultDataApi.Models.BOMStructureEnum>("bOMStructure", BOMStructure);
            writer.WriteEnumValue<global::VaultDataApi.Models.ComponentTypeEnum>("componentType", ComponentType);
            ...
            writer.WriteEnumValue<global::VaultDataApi.Models.XRefTypeEnum>("xRefType", XRefType);
