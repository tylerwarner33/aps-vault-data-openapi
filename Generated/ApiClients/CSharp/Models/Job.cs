...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::VaultDataApi.Models.Job_params? Params { get; set; }
#nullable restore
#else
        public global::VaultDataApi.Models.Job_params Params { get; set; }
#endif
        ...
        public global::VaultDataApi.Models.Job_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::VaultDataApi.Models.Job"/> and sets the default values.
        /// </summary>
        public Job()
        {
        ...
        public static global::VaultDataApi.Models.Job CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::VaultDataApi.Models.Job();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "params", n => { Params = n.GetObjectValue<global::VaultDataApi.Models.Job_params>(global::VaultDataApi.Models.Job_params.CreateFromDiscriminatorValue); } },
                { "priority", n => { Priority = n.GetDoubleValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::VaultDataApi.Models.Job_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::VaultDataApi.Models.Job_params>("params", Params);
            writer.WriteDoubleValue("priority", Priority);
            writer.WriteEnumValue<global::VaultDataApi.Models.Job_status>("status", Status);
