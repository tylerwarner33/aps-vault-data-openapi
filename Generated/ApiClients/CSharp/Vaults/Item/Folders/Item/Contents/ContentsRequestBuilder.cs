...
namespace VaultDataApi.Vaults.Item.Folders.Item.Contents
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::VaultDataApi.Vaults.Item.Folders.Item.Contents.ContentsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::VaultDataApi.Models.EntityCollection?> GetAsync(Action<RequestConfiguration<global::VaultDataApi.Vaults.Item.Folders.Item.Contents.ContentsRequestBuilder.ContentsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::VaultDataApi.Models.EntityCollection> GetAsync(Action<RequestConfiguration<global::VaultDataApi.Vaults.Item.Folders.Item.Contents.ContentsRequestBuilder.ContentsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::VaultDataApi.Vaults.Item.Folders.Item.Contents.ContentsRequestBuilder.ContentsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::VaultDataApi.Vaults.Item.Folders.Item.Contents.ContentsRequestBuilder.ContentsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::VaultDataApi.Vaults.Item.Folders.Item.Contents.ContentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::VaultDataApi.Vaults.Item.Folders.Item.Contents.ContentsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::VaultDataApi.Vaults.Item.Folders.Item.Contents.ContentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get the folder objects and children under it with the given Id in the given vault with vaultId.
        /// </summary>
