...
namespace VaultDataApi.Vaults.Item.SearchResults
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::VaultDataApi.Vaults.Item.SearchResults.SearchResultsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::VaultDataApi.Models.EntityCollection?> GetAsync(Action<RequestConfiguration<global::VaultDataApi.Vaults.Item.SearchResults.SearchResultsRequestBuilder.SearchResultsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::VaultDataApi.Models.EntityCollection> GetAsync(Action<RequestConfiguration<global::VaultDataApi.Vaults.Item.SearchResults.SearchResultsRequestBuilder.SearchResultsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::VaultDataApi.Vaults.Item.SearchResults.SearchResultsRequestBuilder.SearchResultsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::VaultDataApi.Vaults.Item.SearchResults.SearchResultsRequestBuilder.SearchResultsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::VaultDataApi.Vaults.Item.SearchResults.SearchResultsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::VaultDataApi.Vaults.Item.SearchResults.SearchResultsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::VaultDataApi.Vaults.Item.SearchResults.SearchResultsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Basic Search: Find entities using a query string. The text is searched across all properties or both properties and content based on options passed.
        /// </summary>
