...
namespace VaultDataApi.Vaults.WithVaultIdAdvancedSearch
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::VaultDataApi.Vaults.WithVaultIdAdvancedSearch.WithVaultIdAdvancedSearchRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::VaultDataApi.Vaults.WithVaultIdAdvancedSearch.WithVaultIdAdvancedSearchRequestBuilder WithUrl(string rawUrl)
        {
            return new global::VaultDataApi.Vaults.WithVaultIdAdvancedSearch.WithVaultIdAdvancedSearchRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Advanced Search: Allows the user to search for entities within a specified vault. The search can be customized based on various parameters such as entity types (File, Folder, Item, ChangeOrder), specific folders, and search criteria. Users can also sort the results, limit the search to the latest or released files/items only, and decide whether to include subfolders or full models in the search. The &apos;vaultId&apos; is required in the path to identify the targeted Vault.
        /// </summary>
